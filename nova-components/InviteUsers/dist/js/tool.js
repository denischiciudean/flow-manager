                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().get('/nova-vendor/invite-users/user-departments').then(function (res) {
                                    return res.data;
                                });
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return Nova.request().get('/nova-vendor/invite-users/user-roles').then(function (res) {
                                    return res.data;
                                });
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return axios.post('/nova-vendor/invite-users/invite-user', this.form).then(function (res) {
                                    if (res.data.success) {
                                        Nova.success("Utilizator Invitat cu Success");
                                    }
                                }).catch(function (error) {
                                    var errors = Object.keys(error.response.data.errors).map(function (key) {
                                        return [key, error.response.data.errors[key]];
                                    });
                                    errors.map(function (it) {
                                        return Nova.error(it[1][0]);
                                    });
                                });
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Invite Users")]),
      _vm._v(" "),
      _c(
        "card",
        {
          staticClass: "bg-white flex flex-col items-center py-3 px-2",
          staticStyle: { "min-height": "300px" }
        },
        [
          _c("div", { staticClass: "text-gray-700 w-2/3" }, [
            _c("div", { staticClass: "flex items-center justify-between" }, [
              _c("div", { staticClass: "mb-1 md:mb-0 w-1/3 float-left" }, [
              ...
              _c("div", { staticClass: "w-2/3" }, [
                _c("input", {
                  ...
                  staticClass:
                    "w-full h-8 px-2 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline",
                  attrs: {
                    type: "text",
          ...
          _vm._v(" "),
          _c("div", { staticClass: "text-gray-700 w-2/3 mt-3" }, [
            _c("div", { staticClass: "flex items-center justify-between" }, [
              _c("div", { staticClass: "mb-1 md:mb-0 w-1/3 " }, [
              ...
              _c("div", { staticClass: "w-2/3" }, [
                _c("input", {
                  ...
                  attrs: {
                    type: "text",
                    placeholder: "mihaipopescu@email.com",
                    id: "email"
                  },
          ...
          _vm._v(" "),
          _c("div", { staticClass: "inline-block w-2/3 mt-3" }, [
            _c(
              "div",
              {
                staticClass:
                  "w-full md:flex md:items-center justify-between text-gray-700"
              },
              [
                _c("div", { staticClass: "mb-1 md:mb-0 w-1/3" }, [
                  _c("label", { attrs: { for: "nr_telefon" } }, [
                ...
                _c(
                  "select",
                  {
                    ...
                    staticClass:
                      "w-2/3 h-8 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline",
          ...
          _c("div", { staticClass: "flex justify-center mt-3" }, [
            _c(
              ...
              {
                staticClass:
                  "px-3 py-2 bg-blue-400 text-white font-bold rounded",
